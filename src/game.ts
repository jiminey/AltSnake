...
export class Game {
  ...
  private loop() {
    ...
    for (let i = 0; i < this.snake.snake.length - 1; i++) {
      if (
        this.snake.snake[i][0] === this.snake.head[0] &&
      ...
      if (
        this.snake.snake[i][0] === this.snake.head2[0] &&
    ...
    for (let i = 0; i < this.snake.snake2.length - 1; i++) {
      if (
        this.snake.snake2[i][0] === this.snake.head2[0] &&
      ...
      if (
        this.snake.snake2[i][0] === this.snake.head[0] &&
